...
const NavigationMenuItem = ({navItem, children}) => {
    ...
    return (
        <>
            <li className={`cursor-pointer nav-item align-items-center h-100 prevent-select ${isActive ? 'active' : ''}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
